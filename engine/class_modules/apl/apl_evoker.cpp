...
void devastation( player_t* p )
{
  ...
  st->add_action( "dragonrage,if=(cooldown.fire_breath.remains<4|talent.flame_siphon&talent.causality|cooldown.eternity_surge.remains<4&(!talent.mass_disintegrate))&((cooldown.fire_breath.remains<8|talent.flame_siphon&talent.causality|!talent.animosity)&(cooldown.eternity_surge.remains<8|talent.mass_disintegrate|!talent.animosity))&target.time_to_die>=32|fight_remains<32" );
  ...
  st->add_action( "call_action_list,name=es,if=(!talent.dragonrage|variable.next_dragonrage>variable.dr_prep_time_st|!talent.animosity|talent.mass_disintegrate)&(!set_bonus.tww2_4pc|!buff.jackpot.up|talent.mass_disintegrate)" );
