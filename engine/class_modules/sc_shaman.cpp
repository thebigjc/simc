...
void shaman_t::init_action_list_enhancement()
{
  ...
  //_Use_items
    ...
    def->add_action( "use_item,slot=trinket1,if=!variable.trinket1_is_weird&(((talent.ascendance.enabled|talent.deeply_rooted_elements.enabled)&(buff.ascendance.remains>7.5))|(talent.ascendance.enabled&(cooldown.ascendance.remains>fight_remains)))" );
    def->add_action( "use_item,slot=trinket2,if=!variable.trinket2_is_weird&(((talent.ascendance.enabled|talent.deeply_rooted_elements.enabled)&(buff.ascendance.remains>7.5))|(talent.ascendance.enabled&(cooldown.ascendance.remains>fight_remains)))" );
